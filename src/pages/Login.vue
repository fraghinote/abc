          ...
          <q-form @submit="doLogin" class="q-gutter-md" method="post" :action="action">
            ...
            <q-card  flat  class="q-pa-lg ">
              ...
              <q-card-actions class="q-px-md">
                <q-btn unelevated color="blue" size="lg" type="submit" class="full-width" label="Login"   />
              </q-card-actions>
...
<script setup>
//form data
let action = 'https://itouch.cycu.edu.tw/active_system/login/sso/login1.jsp'
let returnPath = window.location.protocol + "//" + window.location.host + "/api/auth.getAuth.jsp?success=true"
let failPath =  window.location.protocol + "//" + window.location.host + "/api/auth.getAuth.jsp?fail=true"
